const CACHE='pantaneira-financeiro-v1.9.1';
const ASSETS=['/','/index.html','/styles.css','/app.js','/v180.js','/v181.js','/v182.js','/v183.js','/v190.js','/v191.js','/manifest.webmanifest'];
